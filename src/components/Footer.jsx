        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <Link to="/">
                <img src={logoImg} alt="JK Tours & Travels" loading="lazy" style={{ maxWidth: '180px', height: 'auto' }} />
              </Link>
            </div>
          ...
          <div className="footer-links-col">
            <h4 onClick={() => toggleExpand('quickLinks')} className={`accordion-header ${expanded.quickLinks ? 'active' : ''}`}>
              Quick Links
              <span className="accordion-icon"></span>
            </h4>
            <div className={`footer-accordion-content ${expanded.quickLinks ? 'open' : ''}`}>
          ...
          <div className="footer-links-col">
            <h4 onClick={() => toggleExpand('destinations')} className={`accordion-header ${expanded.destinations ? 'active' : ''}`}>
              Destinations
              <span className="accordion-icon"></span>
            </h4>
            <div className={`footer-accordion-content ${expanded.destinations ? 'open' : ''}`}>
              <div className="footer-links-double">
                <ul>
          ...
          <div className="footer-contact">
            <h4 onClick={() => toggleExpand('contact')} className={`accordion-header ${expanded.contact ? 'active' : ''}`}>
              Contact
              <span className="accordion-icon"></span>
            </h4>
            <div className={`footer-accordion-content ${expanded.contact ? 'open' : ''}`}>
